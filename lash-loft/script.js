/* Gedeeld over alle vijf de pagina's.
   1. rekent live uit of de salon open is, uit de echte openingstijden
...
(function(){
  ...
  /* Zondag gesloten. [openminuut, sluitminuut]. Vrijdag tot 22:30. */
  var UREN = {
    0: null,
    1: [540, 1320], 2: [540, 1320], 3: [540, 1320], 4: [540, 1320],
    5: [540, 1350],
    6: [570, 1080]
  };
